...
<center>
  <div style="max-width: 600%; margin-top: 20px; " id="carouselExampleAutoplaying" class="carousel slide skew-container" data-bs-ride="carousel">
...
<div style="margin-top: 30px;" class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="col">
        <div style="border:none;" class="card mb-4 rounded-3">
            <div style="border:none; background: white;" class="card-header py-3">
                <a href="screens.elect/electro.php">
                <img style="width: 280px; border-radius: 20px;" src="img/1.PNG" alt="Descripción de la imagen">
                </a>
            </div>
            <div class="card-body">
                <ul class="list-unstyled mt-3 mb-4">
                    <h4 class="my-0 fw-normal">Desayunos</h4>
                </ul>
            </div>
        </div>
    </div>
    <div class="col">
        <div style="border:none; background: white;" class="card mb-4 rounded-3">
            <div style="border:none; background: white;" class="card-header py-3">
                <a href="screens.artqM/articulos.php">
                    <img style="width: 280px; border-radius: 20px;" src="img/2.PNG" alt="Descripción de la imagen">
                </a>
            </div>
            <div class="card-body">
                <ul class="list-unstyled mt-3 mb-4">
                    <h4 class="my-0 fw-normal">Almuerzos</h4>
                </ul>
            </div>
        </div>
    </div>
    <div class="col">
        <div style="border:none; background: white;" class="card mb-4 rounded-3">
            <div style="border:none; background: white;" class="card-header py-3">
                <a href="screens.vaji/hondos.php">
                    <img style="width: 280px; border-radius: 20px;" src="img/3.PNG"alt="Descripción de la imagen">
                </a>
            </div>
            <div class="card-body">
                <ul class="list-unstyled mt-3 mb-4">
                    <h4 class="my-0 fw-normal">Bebidas</h4>
                </ul>
            </div>
        </div>
    </div>
...
.custom-link {
    ...
    /* Media query para dispositivos con ancho de pantalla menor a 768px (típicamente teléfonos) */
    @media (max-width: 767px) {
        /* Modificar estilos para adaptarse a pantallas más pequeñas */
        .content {
            padding: 10px;
        }
    }
...
<center>
    <img style="margin-top: -300px; " src="img/oferta.png" class="d-block w-100" alt="...">
  </center>
...
<div id="carouselExample" class="carousel slide">
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="img/ofe2.png" alt="Licuadora">
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="img/ofe3.png" alt="Licuadora">
        <h2>Tapado De Mariscos</h2>
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="img/ofe4.png" alt="Licuadora">
        <h2>Chilaquiles Guatemaltecos</h2>
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="img/ofe5.png" alt="Licuadora">
        <h2>Chuchitos</h2>
        <p>2 x 1</p>
        <p>Q20.99</p>
        <ul>
