...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/amdc/juegocomdor1.PNG" alt="Licuadora">

        <h2>Cielo</h2>
        <p>Incluye todo el kit.</p>
        <p>Q9999.99</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/juegocomdor2.PNG" alt="Licuadora">
        <h2>Coffe</h2>
        <p>Incluye todo el kit.</p>
        <p>Q.5999.99</p>
        <ul>
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/juegocomdor3.PNG" alt="Licuadora">
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/amdc/juegocomdor4.PNG" alt="Licuadora">
        <h2>Mostaza</h2>
        <p>Incluye todo el kit.</p>
        <p>Q9999.99</p>
        <ul>
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/amdc/juegocomdor5.PNG" alt="Licuadora">
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/juegocomdor6.PNG" alt="Licuadora">
        <h2>Dalmata</h2>
        <p>Incluye todo el kit.</p>
        <p>10999.99</p>
        <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/juegocomdor7.PNG" alt="Licuadora">
        <h2>Beige</h2>
        <p>Incluye todo el kit.</p>
        <p>Q9999.99</p>
         <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/juegocomdor8.PNG" alt="Licuadora">
        <h2>Finali</h2>
        <p>Incluye todo el kit.</p>
        <p>Q9999.99</p>
        <ul>
