    ...
    <div style="background: #9B7A59; height: 90px ;margin-top: 0 px; padding-top: -10px" class="navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" role="search">
        ...
        <a class="nav-link me-2" href="#" role="button" data-bs-toggle="" aria-expanded="false">
          <img style="height: 40px; width: 40px;" src="../img/index/lupa.png" alt="" width="100" height="100">
        </a>
        <div class="d-flex">
        <a href="login.php" class="me-1">
            <img style="margin-left: 80px; height: 50px; width: 50px;" src="../img/index/login.png" alt="" class="img-fluid">
          </a>
          <a href="../carrito/cart.php" class="me-1">
            <img src="../img/index/carrito.png" alt="" class="img-fluid" style="margin-left: 20px; height: 50px; width: 50px;">
          </a>
        </div>
      </form>
    </div>
</nav>
<nav style="padding-top: -10px; height: 60px; background: #6B503C; margin-left: -1px;"> </nav>
...
.custom-link {
 ...
 <div  style=" margin-top: 30px;  " class="row row-cols-1 row-cols-md-4 mb-4 text-center">
                <div    class="col">
                    <div   style="border:none;" class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                     <a href="mesa.php">
    <img  style="width: 280px;" src="../img/mesa.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div     class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4  class="my-0 fw-normal">Mesas</h4>
                ...
                <div class="col">
                    <div    style="border:none; background: white;" class="card mb-4 rounded-3 ">
                        <div   style="border:none; background: white;" class="card-header py-3">
                            <a href="juegocomedor.php">
    <img   style="width: 280px;"  src="../img/juegocomedor.png" alt="Descripción de la imagen">
</a>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4 class="my-0 fw-normal">Juego de comedor</h4>
                ...
                <div class="col">
                    <div  style="border:none; background: white;"  class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                                   <a href="consola.php">
    <img style="width: 280px;"    src="../img/consolas.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div class="card-body">
                         
                            <ul class="list-unstyled mt-3 mb-4">
                              <h4 class="my-0 fw-normal">Consolas</h4>
                            </ul>
                   ...
                   <div class="col">
                    <div  style="border:none; background: white;" class="card mb-4 rounded-3">
                        <div   style="border:none; background: white;"  class="card-header py-3">
                                                   <a href="taburet.php">
    <img style="width: 280px;"    src="../img/taburetes.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div class="card-body">
                         
                            <ul class="list-unstyled mt-3 mb-4">
                              <h4 class="my-0 fw-normal">Taburet</h4>
                            </ul>
...
<div  style=" margin-top: 30px;  " class="row row-cols-1 row-cols-md-4 mb-4 text-center">
                <div    class="col">
                    <div   style="border:none;" class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                                   <a href="alacena.php">
    <img  style="width: 280px;" src="../img/alacenas.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div     class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4  class="my-0 fw-normal">Alacena</h4>
                ...
                <div class="col">
                    <div    style="border:none; background: white;" class="card mb-4 rounded-3 ">
                        <div   style="border:none; background: white;" class="card-header py-3">
                            <a href="banco.php">
    <img   style="width: 280px;"  src="../img/bancos.png" alt="Descripción de la imagen">
</a>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4 class="my-0 fw-normal">Bancos</h4>
                ...
                <div class="col">
                    <div  style="border:none; background: white;"  class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                                   <a href="bares.php">
    <img style="width: 280px;"    src="../img/bares.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div class="card-body">
                         
                            <ul class="list-unstyled mt-3 mb-4">
                              <h4 class="my-0 fw-normal">Bares</h4>
                            </ul>
                   ...
                   <div class="col">
                    <div  style="border:none; background: white;" class="card mb-4 rounded-3">
                        <div   style="border:none; background: white;"  class="card-header py-3">
                                                   <a href="bufeteras.php">
    <img style="width: 280px;"    src="../img/bufeteras.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div class="card-body">
                         
                            <ul class="list-unstyled mt-3 mb-4">
                              <h4 class="my-0 fw-normal">Bufeteras</h4>
                            </ul>
  ...
  <ul class="pagination pagination-lg">
    ...
    <li   class="page-item"><a class="page-link" href="electropag2.php">2</a></li>
