...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/amdc/bar1.PNG" alt="Licuadora">

        <h2>Bar rodante</h2>
        <p>Incluye la cristaleria</p>
        <p>Q11999.99</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/bar2.PNG" alt="Licuadora">
        <h2>Bar Station</h2>
        <p>Incluye la cristaleria</p>
        <p>Q11999.99</p>
        <ul>
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/bar3.PNG" alt="Licuadora">
        <h2>Bar Esquinero</h2>
        <p>Incluye la cristaleria y las botellas</p>
        <p>Q79999.99</p>
         <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/amdc/bar4.PNG" alt="Licuadora">
        <h2>Bar rdelantero</h2>
        <p>Incluye la cristaleria</p>
        <p>Q.5999.99</p>
        <ul>
    <?php
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/amdc/bar5.PNG" alt="Licuadora">


        <h2>Bar de esquina</h2>
        <p>Incluye un tapete</p>
        <p>Q5999.99</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/bar6.PNG" alt="Licuadora">
        <h2>Bar cubo</h2>
        <p>Incluye la cristaleria</p>
        <p>Q.24999.99</p>
        <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/bar7.PNG" alt="Licuadora">
        <h2>Bar desplazadp</h2>
        <p>Incluye la cristaleria</p>
        <p>Q.24999.99</p>
         <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/bar8.PNG" alt="Licuadora">
        <h2>Bar carreta</h2>
        <p>No incluye cristaleria ni botellas</p>
        <p>Q.1999.99</p>
        <ul>
    <?php
    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
