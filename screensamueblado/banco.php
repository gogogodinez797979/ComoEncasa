...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/amdc/banco1.PNG" alt="Licuadora">
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/banco2.PNG" alt="Licuadora">
        <h2>Banca Beige</h2>
        <p>Incluye un tapete</p>
        <p>Q.399.99</p>
        <ul>
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/banco3.PNG" alt="Licuadora">
        <h2>Respaldo Blanco</h2>
        <p>Incluye un tapete</p>
        <p>Q.599.99</p>
         <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/amdc/banco4.PNG" alt="Licuadora">
        <h2>Banco Soft</h2>
        <p>Incluye un tapete</p>
        <p>Q.599.99</p>
        <ul>
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/amdc/banco5.PNG" alt="Licuadora">
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/banco6.PNG" alt="Licuadora">
        <h2>Respaldo Browni</h2>
        <p>Incluye un tapete</p>
        <p>Q.299.99</p>
        <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/banco7.PNG" alt="Licuadora">
        <h2>Banco Whitey</h2>
        <p>Incluye un tapete</p>
        <p>Q.399.99</p>
         <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/banco8.PNG" alt="Licuadora">
        <h2>Banco Rustic</h2>
        <p>Incluye tepete</p>
        <p>Q.700.00</p>
        <ul>
