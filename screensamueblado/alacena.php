...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/amdc/alacena1.PNG" alt="Licuadora">
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/alacena2.PNG" alt="Licuadora">
        <h2>Alacena Delia</h2>
        <p>Incluye el set</p>
        <p>Q.1299.99</p>
        <ul>
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/alacena3.PNG" alt="Licuadora">
        <h2>Alacena Kam</h2>
        <p>Incluye el set</p>
        <p>Q.999.99</p>
         <ul>
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/amdc/alacena4.PNG" alt="Licuadora">
        <h2>Alacena Ila</h2>
        <p>Incluye el set</p>
        <p>Q.1399.99</p>
        <ul>
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/amdc/alacena5.PNG" alt="Licuadora">
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/alacena6.PNG" alt="Licuadora">
        <h2>Alacena Dir</h2>
        <p>Incluye el set</p>
        <p>Q.1899.99</p>
        <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/alacena7.PNG" alt="Licuadora">
        <h2>Alacena DirUp</h2>
        <p>Incluye el set</p>
        <p>Q.499.99</p>
         <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/alacena8.PNG" alt="Licuadora">
        <h2>Alacena LiaUP</h2>
        <p>Incluye el set</p>
        <p>Q.399.99</p>
        <ul>
