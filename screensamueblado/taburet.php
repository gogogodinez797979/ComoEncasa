...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/amdc/taburet1.PNG" alt="Licuadora">
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/taburet2.PNG" alt="Licuadora">
        <h2>Taburet MadiIrmae</h2>
        <p>Incluye el set</p>
        <p>Q.1999.99</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/taburet3.PNG" alt="Licuadora">
        <h2>Taburet Elli</h2>
        <p>Incluye el set</p>
        <p>Q.2999.99</p>
         <ul>
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/amdc/taburet4.PNG" alt="Licuadora">
        <h2>Taburet Indigo</h2>
        <p>Incluye el set</p>
        <p>Q.549.99</p>
        <ul>
    <?php
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/amdc/taburet5.PNG" alt="Licuadora">
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/taburet6.PNG" alt="Licuadora">
        <h2>Taburet Dilia</h2>
        <p>Incluye el set</p>
        <p>Q.1300.00</p>
        <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/taburet7.PNG" alt="Licuadora">
        <h2>Taburet Ilia</h2>
        <p>Incluye el set</p>
        <p>Q.909.99</p>
         <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/taburet8.PNG" alt="Licuadora">
        <h2>Taburet Lib</h2>
        <p>Incluye el set</p>
        <p>Q.899.99</p>
        <ul>
