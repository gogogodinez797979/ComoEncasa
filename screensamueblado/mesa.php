...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/amdc/mesa1.PNG" alt="Licuadora">

        <h2>Mesa Adelina</h2>
        <p>Con una altura de 50 cm y de 60*80 cm<p>
        <p>Q199.99</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/mesa2.PNG" alt="Licuadora">
        <h2>Mesa Candida</h2>
        <p>Con una altura de 1.10 m y de 170*100 cm</p>
        <p>Q.300.00</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/mesa3.PNG" alt="Licuadora">
        <h2>Mesa Continental</h2>
        <p>Con una altura de 1.10 m y de 170*100 cm</p>
        <p>Q.500.00</p>
         <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/amdc/mesa4.PNG" alt="Licuadora">
        <h2>Mesa Lina</h2>
        <p>Con una altura de 1.10 m y de 170 cm de diametro</p>
        <p>Q.700.00</p>
        <ul>
    <?php
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/amdc/mesa5.PNG" alt="Licuadora">
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/mesa6.PNG" alt="Licuadora">
        <h2>Mesa Lidia</h2>
        <p>Con una altura de 1.10 m y de 170*100 cm</p>
        <p>Q.599.99</p>
        <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/mesa7.PNG" alt="Licuadora">
        <h2>Mesa Roble</h2>
        <p>Con una altura de 1.10 m y de 170*100 cm</p>
        <p>Q.4999.99</p>
         <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/mesa8.PNG" alt="Licuadora">
        <h2>Mesa Libiana</h2>
        <p>Con una altura de 1.10 m y de 170 cm de diametro</p>
        <p>Q.199.99</p>
        <ul>
