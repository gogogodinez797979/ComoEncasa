...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/amdc/consola1.PNG" alt="Licuadora">

        <h2>Consola Metal</h2>
        <p>Con una altura de 60cm de altura y 70*70 cm</p>
        <p>549.99</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/consola2.PNG" alt="Licuadora">
        <h2>Consola Roble</h2>
        <p>Con una altura de 60cm de altura y 70*70 cm</p>
        <p>Q.549.99</p>
        <ul>
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/consola3.PNG" alt="Licuadora">
        <h2>Consola Nocturna</h2>
        <p>Con una altura de 60cm de altura y 70*70 cm</p>
        <p>Q.549.99</p>
         <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/amdc/consola4.PNG" alt="Licuadora">
        <h2>Consola Bety</h2>
        <p>Con una altura de 60cm de altura y 70*70 cm</p>
        <p>Q.499.99</p>
        <ul>
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/amdc/consola5.PNG" alt="Licuadora">


        <h2>Consola Madie</h2>
        <p>Con una altura de 60cm de altura y 70*30 cm</p>
        <p>Q.549.99</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/consola6.PNG" alt="Licuadora">
        <h2>Consola Fontana</h2>
        <p>Con una altura de 60cm de altura y 70*30 cm</p>
        <p>Q.399.99</p>
        <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/consola7.PNG" alt="Licuadora">
        <h2>Consola Liliana</h2>
        <p>Con una altura de 60cm de altura y 70*70 cm</p>
        <p>Q.699.99</p>
         <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/consola8.PNG" alt="Licuadora">
        <h2>Consola Inti</h2>
        <p>Con una altura de 60cm de altura y 70*70 cm</p>
        <p>Q.739.99</p>
        <ul>
