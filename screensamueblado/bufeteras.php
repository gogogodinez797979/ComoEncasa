...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/amdc/buf1.PNG" alt="Licuadora">

        <h2>Bufetera Stonk</h2>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/buf2.PNG" alt="Licuadora">
        <h2>Bufetera oriental</h2>
        <p>Incluye un tapete</p>
        <p>Q.4999.99</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/buf3.PNG" alt="Licuadora">
        <h2>Bufetera Beige</h2>
        <p>Incluye un tapete</p>
        <p>Q.4999.99</p>
         <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/amdc/buf4.PNG" alt="Licuadora">
        <h2>Bufetera Neutral</h2>
        <p>Incluye un tapete</p>
        <p>Q.3999.99</p>
        <ul>
    <?php
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/amdc/buf5.PNG" alt="Licuadora">
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/buf6.PNG" alt="Licuadora">
        <h2>Bufetera Brownie</h2>
        <p>Incluye un tapete</p>
        <p>Q.4999.99</p>
        <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/amdc/buf7.PNG" alt="Licuadora">
        <h2>Bufetera Cartoon</h2>
        <p>Incluye un tapete</p>
        <p>Q.2999.99</p>
         <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/amdc/buf8.PNG" alt="Licuadora">
        <h2>Bufetera Roble</h2>
        <p>Incluye un tapete</p>
        <p>Q.4999.99</p>
        <ul>
    <?php
