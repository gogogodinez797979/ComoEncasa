...
<center>
    <img style="margin-top: 30px;" src="../img/1.png" class="d-block w-100" alt="...">
  </center>
                ...
                <div    class="col">
                    <div   style="border:none;" class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                                   <a href="electro.php">
    <img  style="width: 280px;" src="../img/licuadora.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div     class="card-body">
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4  class="my-0 fw-normal">Licuadoras</h4>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div    style="border:none; background: white;" class="card mb-4 rounded-3 ">
                        <div   style="border:none; background: white;" class="card-header py-3">
                            <a href="estufa.php">
    <img   style="width: 280px;"  src="../img/estufa.jpg" alt="Descripción de la imagen">
</a>     
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4 class="my-0 fw-normal">Estufas</h4>
                            </ul>
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div  style="border:none; background: white;"  class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                                   <a href="refri.php">
    <img style="width: 280px;" src="../img/Refrigerador.jpeg" alt="Descripción de la imagen">
                      </a>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mt-3 mb-4">
                              <h4 class="my-0 fw-normal">Refrigeradores</h4>
                            </ul>
                        </div>
                    </div>
                </div>
                   <div class="col">
                    <div  style="border:none; background: white;" class="card mb-4 rounded-3">
                        <div   style="border:none; background: white;"  class="card-header py-3">
                                                   <a href="micro.php">
    <img style="width: 280px;" src="../img/microondas1.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mt-3 mb-4">
                              <h4 class="my-0 fw-normal">Microondas</h4>
                            </ul>
                        </div>
                    </div>
                </div>
...
<div  style=" margin-top: 30px;  " class="row row-cols-1 row-cols-md-4 mb-4 text-center">
                <div    class="col">
                    <div   style="border:none;" class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                                   <a href="hornoT.php">
    <img  style="width: 280px;" src="../img/microondas2.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div     class="card-body">
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4  class="my-0 fw-normal">Horno Tostador</h4>
                            </ul>  
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div    style="border:none; background: white;" class="card mb-4 rounded-3 ">
                        <div   style="border:none; background: white;" class="card-header py-3">
                            <a href="batidora.php">
    <img   style="width: 280px;"  src="../img/batidora.jpg" alt="Descripción de la imagen">
</a>
                            
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4 class="my-0 fw-normal">Batidoras</h4>
                            </ul>  
                        </div>
                    </div>
                </div>
                <div class="col">
                    <div  style="border:none; background: white;"  class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                                   <a href="cafetera.php">
    <img style="width: 280px;"    src="../img/cafetera.jpg" alt="Descripción de la imagen">
</a>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mt-3 mb-4">
                              <h4 class="my-0 fw-normal">Cafeteras</h4>
                            </ul>
                        </div>
                    </div>
                </div>
                   <div class="col">
                    <div  style="border:none; background: white;" class="card mb-4 rounded-3">
                        <div   style="border:none; background: white;"  class="card-header py-3">
                                                   <a href="wafle.php">
    <img style="width: 280px;"    src="../img/waflera1.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div class="card-body">
                            <ul class="list-unstyled mt-3 mb-4">
                              <h4 class="my-0 fw-normal">Wafleras</h4>
                            </ul>
                        </div>
                    </div>
                </div>
