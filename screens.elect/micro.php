...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/electro/micro1.PNG" alt="Licuadora">

        <h2>Samsung</h2>
        <p>Con varias opciones para utilizar.</p>
        <p>Q.999.99</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/micro2.PNG" alt="Licuadora">
        <h2>Samsung</h2>
        <p>Con varias opciones para utilizar.</p>
        <p>Q.999.99</p>
        <ul>
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/micro3.PNG" alt="Licuadora">
        <h2>LG</h2>
        <p>Con varias opciones para utilizar.</p>
        <p>Q.999.99</p>
         <ul>
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/electro/micro4.PNG" alt="Licuadora">
        <h2>Oster</h2>
        <p>Con varias opciones para utilizar.</p>
        <p>Q.999.99</p>
        <ul>
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/electro/micro5.PNG" alt="Licuadora">
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/micro6.PNG" alt="Licuadora">
        <h2>ELECTROLUX</h2>
        <p>Con varias opciones para utilizar.</p>
        <p>Q.999.99</p>
        <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/micro7.PNG" alt="Licuadora">
        <h2>Mabe</h2>
        <p>Con varias opciones para utilizar.</p>
        <p>Q.999.99</p>
         <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/micro8.PNG" alt="Licuadora">
        <h2>Indurama</h2>
        <p>Con varias opciones para utilizar.</p>
        <p>Q.999.99</p>
        <ul>
