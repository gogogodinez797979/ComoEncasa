 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
                <div class="col">
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('19')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div  class="products">
    <div class="product" onclick="showProduct('19')">
        <img  style="width: 280px;" src="../img/electro/freidora1.PNG" alt="Licuadora">

        <h2>Freidora Philips</h2>
...
<ul>
    <?php
    $producto_id = 19; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    ...
    ?>
            ...
            <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('20')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('20')">
        <img   style="width: 280px;" src="../img/electro/freidora2.PNG" alt="Licuadora">
        <h2>Freidora Ninja</h2>
        <p> Alto rendimiento.</p>
        <p>Q.999.99</p>
        <ul>
    <?php
    $producto_id = 20; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
    ...
    ?>
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('21')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('21')">
        <img   style="width: 280px;" src="../img/electro/freidora3.PNG" alt="Licuadora">
        <h2>Freidora Cosori</h2>
        <p> Alto rendimiento.</p>
        <p>Q.999.99</p>
         <ul>
    <?php
    $producto_id = 21; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
    ...
    ?>
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('22')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('22')">
        <img   style="width: 280px;" src="../img/electro/freidora4.png" alt="Licuadora">
        <h2>Freidora Instant Pot</h2>
        <p> Alto rendimiento.</p>
        <p>Q.999.99</p>
        <ul>
    <?php
    $producto_id = 22; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
                <div class="col">
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('23')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('23')">
        <img   style="width: 280px;" src="../img/electro/freidora5.PNG" alt="Licuadora">


        <h2>Freidora PowerXL</h2>
        <p> Alto rendimiento.</p>
        <p>Q.999.99</p>
...
<ul>
    <?php
    $producto_id = 23; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
