...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/electro/vapor1.PNG" alt="Licuadora">

        <h2>Vaporera crossorigin</h2>
        <p>Tamaño familiar</p>
        <p>Q.250.99</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/vapor2.PNG" alt="Licuadora">
        <h2>Vaporera Chefman</h2>
        <p>Tamaño familiar</p>
        <p>Q.250.99</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/vapor3.PNG" alt="Licuadora">
        <h2>Vaporera GoWISE USA</h2>
        <p>Tamaño familiar</p>
        <p>Q.250.99</p>
         <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/electro/vapor4.png" alt="Licuadora">
        <h2>Vaporera Dash</h2>
        <p>Tamaño familiar</p>
        <p>Q.250.99</p>
        <ul>
