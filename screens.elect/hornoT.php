...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/electro/horno1.PNG" alt="Licuadora">

        <h2>Horno Electrolux</h2>
        <p>Su temperatura llega hasta  170 ºC</p>
        <p>Q.500.00</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/horno2.PNG" alt="Licuadora">
        <h2>Horno Zanussi</h2>
        <p>Su temperatura llega hasta  170 ºC</p>
        <p>Q.500.00</p>
        <ul>
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/horno3.PNG" alt="Licuadora">
        <h2>Horno Fagor</h2>
        <p>Su temperatura llega hasta  170 ºC</p>
        <p>Q.500.00</p>
         <ul>
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/electro/horno4.PNG" alt="Licuadora">
        <h2>Horno Teka</h2>
        <p>Su temperatura llega hasta  170 ºC</p>
        <p>Q.500.00</p>
        <ul>
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/electro/horno5.PNG" alt="Licuadora">
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/horno6.PNG" alt="Licuadora">
        <h2>Horno Balay</h2>
        <p>Su temperatura llega hasta  170 ºC</p>
        <p>Q.500.00</p>
        <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/horno7.PNG" alt="Licuadora">
        <h2>Horno Bosh</h2>
        <p>Su temperatura llega hasta  170 ºC</p>
        <p>Q.500.00</p>
         <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/horno8.PNG" alt="Licuadora">
        <h2>Horno Siemens</h2>
        <p>Su temperatura llega hasta  170 ºC</p>
        <p>Q.500.00</p>
        <ul>
