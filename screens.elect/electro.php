...
<style>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/desa1.PNG" alt="Licuadora">

        <h2>Tortillas Ahogadas</h2>
        <p></p>
        <p>Q49.00</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/desa2.png" alt="Licuadora">
        <h2>Cacerola Con Pollo</h2>
        <p></p>
        <p>Q.60.00</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/desa3.PNG" alt="Licuadora">
        <h2>Huevos Indecisos</h2>
        <p></p>
        <p>Q.40.00</p>
         <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/desa4.png" alt="Licuadora">
        <h2>Omelette De La Casa</h2>
        <p></p>
        <p>Q55.00</p>
        <ul>
    <?php
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
                <div class="col">
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('5')" class="card-header py-3">
    ...
    <div class="product" onclick="showProduct('5')">
        <img   style="width: 280px;" src="../img/desa5.PNG" alt="Licuadora">
...
<ul>
    ...
    ?>
            ...
            <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('6')" class="card-header py-3">
    ...
    <div class="product" onclick="showProduct('6')">
        <img   style="width: 280px;" src="../img/desa6.PNG" alt="Licuadora">
        <h2>Chilaquiles 3 Tiempos</h2>
        <p>.</p>
        <p>Q40.00</p>
        <ul>
    <?php
    $producto_id = 6; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
    ...
    ?>
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('7')" class="card-header py-3">
    ...
    <div class="product" onclick="showProduct('7')">
        <img   style="width: 280px;" src="../img/desa7.PNG" alt="Licuadora">
        <h2>Panqueques De Elote</h2>
        <p></p>
        <p>Q.40.00</p>
         <ul>
    <?php
    $producto_id = 7; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
