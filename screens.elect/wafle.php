...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/electro/waf1.PNG" alt="Licuadora">

        <h2>Wafleras Chefman</h2>
        <p>Preparación en 5 minutos.</p>
        <p>Q.530.00</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/waf2.PNG" alt="Licuadora">
        <h2>Wafleras krups</h2>
        <p>Preparación en 5 minutos.</p>
        <p>Q.530.00</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/waf3.PNG" alt="Licuadora">
        <h2>Wafleras Dash</h2>
        <p>Preparación en 5 minutos.</p>
        <p>Q.530.00</p>
         <ul>
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/electro/waf4.PNG" alt="Licuadora">
        <h2>Wafleras Breville</h2>
        <p>Preparación en 5 minutos.</p>
        <p>Q.530.00</p>
        <ul>
    <?php
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/electro/waf5.PNG" alt="Licuadora">


        <h2>Wafleras Black-Decker</h2>
        <p>Preparación en 5 minutos.</p>
        <p>Q.530.00</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/waf6.PNG" alt="Licuadora">
        <h2>Wafleras Hamilton Beach</h2>
        <p>Preparación en 5 minutos.</p>
        <p>Q.530.00</p>>
        <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/waf7.PNG" alt="Licuadora">
        <h2>Wafleras Cuisinart</h2>
        <p>Preparación en 5 minutos.</p>
        <p>Q.530.00</p>
         <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/waf8.PNG" alt="Licuadora">
        <h2>Wafleras Oster</h2>
        <p>Preparación en 5 minutos.</p>
        <p>Q.530.00</p>
        <ul>
    <?php
