...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/electro/refri1.PNG" alt="Licuadora">
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/refri2.PNG" alt="Licuadora">
        <h2>Refrigerador LG c45</h2>
        <p>335 L.</p>
        <p>Q.5999.99</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/refri3.PNG" alt="Licuadora">
        <h2>Refrigerador LG f5 </h2>
        <p>400 L.</p>
        <p>Q.7999.99</p>>
         <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/electro/refri4.PNG" alt="Licuadora">
        <h2>Refrigerador LG </h2>
        <p>200 L.</p>
        <p>Q.4999.99</p>
        <ul>
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/electro/refri5.PNG" alt="Licuadora">


        <h2>Refrigerador Samsung </h2>
        <p>400 L.</p>
        <p>Q.10000.99</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/refri6.PNG" alt="Licuadora">
       
        <h2>Refrigerador Samsung a23</h2>
        <p>400 L.</p>
        <p>Q.10000.99</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/refri7.PNG" alt="Licuadora">
        <h2>Refrigerador Samsung g45 </h2>
        <p>350 L.</p>
        <p>Q.6999.99</p>
         <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/refri8.PNG" alt="Licuadora">
        <h2>Refrigerador Samsung </h2>
        <p>400 L.</p>
        <p>Q.10000.99</p>
        <ul>
