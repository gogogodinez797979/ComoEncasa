...
<center>
  <div style="max-width: 600px; margin-top: 20px; " id="carouselExampleAutoplaying" class="carousel slide skew-container" data-bs-ride="carousel">
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
                <div class="col">
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('11')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div  class="products">
    <div class="product" onclick="showProduct('11')">
        <img  style="width: 280px;" src="../img/electro/estufa1.PNG" alt="Licuadora">

        <h2>Estufa Michigan</h2>
        <p>Cuenta con 6 hornias</p>
        <p>Q4090.99</p>
...
<ul>
    <?php
    $producto_id = 11; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    ...
    ?>
            ...
            <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('12')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('12')">
        <img   style="width: 280px;" src="../img/electro/estufa2.PNG" alt="Licuadora">
        <h2>Estufa OMLOX</h2>
        <p>Cuenta con 6 hornias</p>
        <p>Q.3999.99</p>
        ...
        <ul>
    <?php
    $producto_id = 12; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
    ...
    ?>
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('13')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('13')">
        <img   style="width: 280px;" src="../img/electro/estufa3.PNG" alt="Licuadora">
        <h2>Estufa STARDIS</h2>
        <p>Cuenta con 6 hornias</p>
        <p>Q4999.99</p>
       
         <ul>
    <?php
    $producto_id = 13; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
    ...
    ?>
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('14')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('14')">
        <img   style="width: 280px;" src="../img/electro/estufa4.PNG" alt="Licuadora">
        <h2>Estufa OMLOX C12</h2>
        <p>Cuenta con 6 hornias</p>
        <p>Q5999.99</p>
       
        <ul>
    <?php
    $producto_id =14; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
                <div class="col">
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('15')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('15')">
        <img   style="width: 280px;" src="../img/electro/estufa5.PNG" alt="Licuadora">


        <h2>Estufa DiGreto</h2>
        <p>Cuenta con 6 hornias</p>
        <p>Q.2000.99</p>
...
<ul>
    <?php
    $producto_id = 15; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
    ...
    ?>
            ...
            <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('16')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('16')">
        <img   style="width: 280px;" src="../img/electro/estufa6.PNG" alt="Licuadora">
        <h2>Estufa Oster</h2>
        <p>Cuenta con 6 hornias</p>
        <p>Q.5999.99</p>
        ...
        <ul>
    <?php
    $producto_id = 16; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
    ...
    ?>
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('17')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('17')">
        <img   style="width: 280px;" src="../img/electro/estufa7.PNG" alt="Licuadora">
        <h2>Estufa Dimirmiz</h2>
        <p>Cuenta con 6 hornias</p>
        <p>Q4090.99</p>
       
         <ul>
    <?php
    $producto_id = 17; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
    ...
    ?>
                ...
                <div class="col">
                    <div class="card mb-4 rounded-3 shadow-sm">
                        <div class="product" onclick="showproduct('18')" class="card-header py-3">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('18')">
        <img   style="width: 280px;" src="../img/electro/estufa8.PNG" alt="Licuadora">
        <h2>Estufa RUBOX</h2>
        <p>Cuenta con 4 hornias</p>
        <p>Q4090.99</p>
       
        <ul>
    <?php
    $producto_id = 18; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    $sql = "SELECT * FROM productos WHERE id = $producto_id"; // Consulta SQL para seleccionar el producto específico
    $result = $conn->query($sql);
