...
<center>
 ...
 <div  style=" margin-top: 30px;  " class="row row-cols-1 row-cols-md-4 mb-4 text-center">
                <div    class="col">
                    <div   style="border:none;" class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                                   <a href="extrajugo.php">
    <img  style="width: 280px;" src="../img/extractorjugo.jpg" alt="Descripción de la imagen">
</a>
                        </div>
                        <div     class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4  class="my-0 fw-normal">Extractor de Jugo</h4>
                ...
                <div class="col">
                    <div    style="border:none; background: white;" class="card mb-4 rounded-3 ">
                        <div   style="border:none; background: white;" class="card-header py-3">
                            <a href="freidoraaire.php">
    <img   style="width: 280px;"  src="../img/freidora.jpg" alt="Descripción de la imagen">
</a>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4 class="my-0 fw-normal">Freidora de Aire</h4>
                ...
                <div class="col">
                    <div  style="border:none; background: white;"  class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                                   <a href="vaporera.php">
    <img style="width: 280px;"    src="../img/vaporera.jpg" alt="Descripción de la imagen">
</a>
                        </div>
                        <div class="card-body">
                         
                            <ul class="list-unstyled mt-3 mb-4">
                              <h4 class="my-0 fw-normal">Vaporera</h4>
                            </ul>
  ...
  <ul class="pagination pagination-lg">
   <li class="page-item"><a class="page-link" href="indexelectro.php">1</a></li>
    <li  class="page-item active" aria-current="page" class="page-item"><a class="page-link" href="electropag2.php">2</a></li>
