...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/electro/cafe1.PNG" alt="Licuadora">

        <h2>Cafetera Philips</h2>
        <p>El proceso de preparación tarda 5 min.</p>
        <p>Q599.99</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/cafe2.PNG" alt="Licuadora">
        <h2>Cafetera Nespresso</h2>
        <p>El proceso de preparación tarda 5 min.</p>
        <p>Q599.99</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/cafe3.PNG" alt="Licuadora">
        <h2>Cafetera Breville</h2>
        <p>El proceso de preparación tarda 5 min.</p>
        <p>Q599.99</p>
         <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/electro/cafe4.PNG" alt="Licuadora">
        <h2>Cafetera Keurig</h2>
        <p>El proceso de preparación tarda 5 min.</p>
        <p>Q599.99</p>
        <ul>
    <?php
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/electro/cafe5.PNG" alt="Licuadora">


        <h2>Cafetera De'Longhi</h2>
        <p>El proceso de preparación tarda 5 min.</p>
        <p>Q599.99</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/cafe6.PNG" alt="Licuadora">
        <h2>Cafetera Hamilton Beach</h2>
        <p>El proceso de preparación tarda 5 min.</p>
        <p>Q599.99</p>
        <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/cafe7.PNG" alt="Licuadora">
        <h2>Cafetera PhiliBosch</h2>
        <p>El proceso de preparación tarda 5 min.</p>
        <p>Q599.99</p>
         <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/cafe8.PNG" alt="Licuadora">
