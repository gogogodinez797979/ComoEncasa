...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/electro/jugo1.PNG" alt="Licuadora">

        <h2>Extractor Breville</h2>
        <p>Cuenta con 5 velocidades</p>
        <p>Q.900.99</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/jugo2.PNG" alt="Licuadora">

        <h2>Extractor Hurom</h2>
        <p>Cuenta con 5 velocidades</p>
        <p>Q.900.99</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/jugo3.PNG" alt="Licuadora">
        <h2>Extractor Kuvings</h2>
        <p>Cuenta con 5 velocidades</p>
        <p>Q.900.99</p>
         <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/electro/jugo4.PNG" alt="Licuadora">
        <h2>Extractor Hamilton</h2>
        <p>Cuenta con 5 velocidades</p>
        <p>Q.900.99</p>
        <ul>
    <?php
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/electro/jugo5.PNG" alt="Licuadora">


        <h2>Extractor Aikok</h2>
        <p>Cuenta con 5 velocidades</p>
        <p>Q.900.99</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/jugo6.PNG" alt="Licuadora">
        <h2>Extractor Tribest</h2>
        <p>Cuenta con 5 velocidades</p>
        <p>Q.900.99</p>
        <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/jugo7.PNG" alt="Licuadora">
        <h2>Extractor Cuisinart</h2>
        <p>Cuenta con 5 velocidades</p>
        <p>Q.900.99</p>
         <ul>
    <?php
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/jugo8.PNG" alt="Licuadora">
        <h2>Licuadora</h2>
        <p>Potente licuadora de 1000W con varias velocidades.</p>
        <p>$49.99</p>
        <ul>
    <?php
    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
