...
<nav class="navbar-expand-lg bg-body-tertiary">
    ...
    <div style="background: #9B7A59; height: 90px ;margin-top: 0 px; padding-top: -10px" class="navbar-collapse" id="navbarSupportedContent">
      ...
      <form class="d-flex" role="search">
        ...
        <img style="height: 40px; width: 40px;" src="../img/index/lupa.png" alt="" class="img-fluid" style="height: 50px; width: 50px;">
        </a>
...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/electro/batidora1.PNG" alt="Licuadora">

        <h2>KitchenAid</h2>
        <p>Hasta con 5 velocidades</p>
        <p>Q490.99</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/batidora2.PNG" alt="Licuadora">
        <h2>Hamilton Beach</h2>
        <p>Hasta con 5 velocidades</p>
        <p>Q490.99</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/batidora3.PNG" alt="Licuadora">
        <h2>Oster</h2>
        <p>Hasta con 5 velocidades</p>
        <p>Q490.99</p>
         <ul>
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/electro/batidora4.PNG" alt="Licuadora">
        <h2>Cuisinart</h2>
        <p>Hasta con 5 velocidades</p>
        <p>Q490.99</p>
        <ul>
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/electro/batidora5.PNG" alt="Licuadora">
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/batidora6.PNG" alt="Licuadora">
        <h2>RCA</h2>
        <p>Hasta con 5 velocidades</p>
        <p>Q490.99</p>
        <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/electro/batidora7.PNG" alt="Licuadora">
        <h2>Dash</h2>
        <p>Hasta con 5 velocidades</p>
        <p>Q490.99</p>
         <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/electro/batidora8.PNG" alt="Licuadora">
        <h2>Black and Decker</h2>
        <p>Hasta con 5 velocidades</p>
        <p>Q490.99</p>
        <ul>
    <?php
