	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/vaji/salsera1.png" alt="Licuadora">

	                <h2>Salsera Simple</h2>
	                <p>Salsera simple y elegante para café.</p>
	                <p>Q45.00</p>
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/salsera2.png" alt="Licuadora">
	                <h2>Salsera Color Cafes</h2>
	                <p>Salsera en tonos cafés para un toque clásico.</p>
	                <p>Q50.00</p>
	                <ul>
	                  <?php
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/vaji/salsera3.png" alt="Hondos">
	                <h2>Salsera Cuadrada</h2>
	                <p>Salsera con diseño cuadrado para café.</p>
	                <p>Q55.00</p>
	                <ul>
	                  <?php
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('4')">
	                <img style="width: 280px;" src="../img/vaji/salsera4.png" alt="Hondos">
	                <h2>Salsera Color Gris</h2>
	                <p>Salsera de color gris con estilo moderno.</p>
	                <p>Q60.00</p>
	                <ul>
	                  <?php
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/vaji/salsera5.png" alt="Hondos">


	                <h2>Salsera Baja</h2>
	                <p>Salsera baja ideal para espresso.</p>
	                <p>Q70.00</p>
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/salsera6.png" alt="Hondos">
	                <h2>Salsera Grande</h2>
	                <p>Salsera grande para tus tazas de café.</p>
	                <p>Q80.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/vaji/salsera7.png" alt="Hondos">
	                <h2>Salsera Texturizada</h2>
	                <p>Salsera con textura única para café.</p>
	                <p>Q95.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/salsera8.png" alt="Hondos">
	                <h2>Salsera Texturizada</h2>
	                <p>Salsera con textura única para café.</p>
	                <p>Q95.00</p>
	                <ul>
