                    ...
                    <ul class="list-unstyled mt-3 mb-4">
                        <div class="products">
                            <div class="product" onclick="showProduct('1')">
                                <img style="width: 280px;" src="../img/vaji/vidrio1.png" alt="Licuadora">

                                <h2>Vaso de Vidrio Grande con Textura</h2>
                                <p>Vaso de vidrio grande, ideal para bebidas refrescantes y para compartir.</p>
                                <p>Q25.00</p>
                    ...
                    <ul class="list-unstyled mt-3 mb-4">
                        <div class="products">
                            <div class="product" onclick="showProduct('2')">
                                <img style="width: 280px;" src="../img/vaji/vidrio2.png" alt="Licuadora">
                                <h2>Juego de Platos de Vidrio</h2>
                                <p>Juego completo de platos de vidrio para servir tus mejores vocadillos.</p>
                                <p>Q60.00/p>
                                <ul>
                                    <?php
                    ...
                    <ul class="list-unstyled mt-3 mb-4">
                        <div class="products">
                            <div class="product" onclick="showProduct('3')">
                                <img style="width: 280px;" src="../img/vaji/vidrio3.png" alt="Hondos">
                                <h2>Platos de Vidrio Hondos</h2>
                                <p>Platos hondos de vidrio, perfectos para sopas y ensaladas.</p>
                                <p>Q50.00</p>
                                <ul>
                                    <?php
                    ...
                    <ul class="list-unstyled mt-3 mb-4">
                        <div class="products">
                            <div class="product" onclick="showProduct('4')">
                                <img style="width: 280px;" src="../img/vaji/vidrio4.png" alt="Hondos">
                                <h2>Platos de Vidrio Morados</h2>
                                <p>Platos de vidrio morado, añaden un toque de color a la mesa.</p>
                                <p>Q55.00</p>
                                <ul>
                                    <?php
            ...
            <div class="card mb-4 rounded-3 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mt-3 mb-4">
                        <div class="products">
                            <div class="product" onclick="showProduct('1')">
                                <img style="width: 280px;" src="../img/vaji/vidrio5.png" alt="Hondos">


                                <h2>Vasos de Vidrio Altos de Vidrio</h2>
                                <p>Vasos altos de vidrio, ideales para cócteles y jugos para el verano.</p>
                                <p>Q30.00</p>
            ...
            <div class="card mb-4 rounded-3 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mt-3 mb-4">
                        <div class="products">
                            <div class="product" onclick="showProduct('2')">
                                <img style="width: 280px;" src="../img/vaji/vidrio6.png" alt="Hondos">
                                <h2>Vasos de Vidrio Texturizado</h2>
                                <p>Vasos de vidrio con textura, para un estilo único en tu hogar.</p>
                                <p>Q35.00/p>
                                <ul>
                                    <?php
                                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
            ...
            <div class="card mb-4 rounded-3 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mt-3 mb-4">
                        <div class="products">
                            <div class="product" onclick="showProduct('3')">
                                <img style="width: 280px;" src="../img/vaji/vidrio7.png" alt="Hondos">
                                <h2>Juego de Vasos de 6Pzs</h2>
                                <p>Juego de seis vasos de vidrio, perfectos para cualquier ocasión.</p>
                                <p>Q75.00</p>
                                <ul>
                                    <?php
                                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
            ...
            <div class="card mb-4 rounded-3 shadow-sm">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-unstyled mt-3 mb-4">
                        <div class="products">
                            <div class="product" onclick="showProduct('2')">
                                <img style="width: 280px;" src="../img/vaji/vidrio8.png" alt="Hondos">
                                <h2>Vasos de Vidrio Bajitos de 6Pzs</h2>
                                <p>Vasos de vidrio bajitos, ideales para bebidas cortas y rrefrescantes.</p>
                                <p>Q20.00</p>
                                <ul>
                                    <?php
                                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
