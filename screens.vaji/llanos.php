	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/vaji/Llano1.png" alt="Licuadora">

	                <h2>Plato Llano 1</h2>
	                <p>Plato llano simple y elegante</p>
	                <p>Q55.00</p>
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/Llano2.png" alt="Licuadora">
	                <h2>Plato Llano 2</h2>
	                <p>Plato llano moderno</p>
	                <p>Q35.00</p>
	                <ul>
	                  <?php
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/vaji/Llano3.png" alt="Hondos">
	                <h2>Plato Llano 3</h2>
	                <p>Plato llano con diseño</p>
	                <p>Q90.00</p>
	                <ul>
	                  <?php
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('4')">
	                <img style="width: 280px;" src="../img/vaji/Llano4.png" alt="Hondos">
	                <h2>Plato Llano 4</h2>
	                <p>Plato llano clásico</p>
	                <p>Q45.00</p>
	                <ul>
	                  <?php
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/vaji/Llano5.png" alt="Hondos">


	                <h2>Plato Llano 5</h2>
	                <p>Plato llano decorativo</p>
	                <p>Q75.00</p>
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/Llano6.png" alt="Hondos">
	                <h2>Plato Llano 6</h2>
	                <p>Plato llano elegante y funcional</p>
	                <p>Q50.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/vaji/Llano7.png" alt="Hondos">
	                <h2>Plato Llano 7</h2>
	                <p>Plato llano con acabado especial</p>
	                <p>Q60.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/Llano8.png" alt="Hondos">
	                <h2>Plato Llano 8</h2>
	                <p>Plato llano premium</p>
	                <p>Q40.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
