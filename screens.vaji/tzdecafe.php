	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/vaji/coffetaz1.png" alt="Licuadora">

	                <h2>Taza Azul con Orillas Cafés</h2>
	                <p>Taza de café con un elegante tono azul y orillas en color café. Perfecta para empezar el día con estilo.</p>
	                <p>Q30.00</p>
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/coffetaz2.png" alt="Licuadora">
	                <h2>Taza Beig Vintage</h2>
	                <p>Taza de café en color beig con un diseño vintage que evoca una sensación de nostalgia y elegancia.</p>
	                <p>Q32.00</p>
	                <ul>
	                  <?php
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/vaji/coffetaz3.png" alt="Hondos">
	                <h2>Taza Verde Degradado</h2>
	                <p>aza de café con un hermoso degradado verde. Ideal para quienes aprecian un toque de color en sus momentos de café.</p>
	                <p>Q33.00</p>
	                <ul>
	                  <?php
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('4')">
	                <img style="width: 280px;" src="../img/vaji/coffetaz4.png" alt="Hondos">
	                <h2>Taza de Cafe Beig Claro Simple</h2>
	                <p>Taza de café en color beig liso, simple y sofisticada. Ideal para cualquier ocasión.</p>
	                <p>Q28.00</p>
	                <ul>
	                  <?php
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/vaji/coffetaz5.png" alt="Hondos">


	                <h2>Taza Gris con Textura color Negro</h2>
	                <p>Taza de café con un diseño en gris pintilla. Ofrece un toque moderno y elegante a tu rutina.</p>
	                <p>Q30.00</p>
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/coffetaz6.png" alt="Hondos">
	                <h2>Taza Blanca con Detalles Azul</h2>
	                <p>Taza blanca con delicados detalles en azul, un diseño fresco y moderno para disfrutar tu café.</p>
	                <p>Q31.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/vaji/coffetaz7.png" alt="Hondos">
	                <h2>Taza Blanca con Rayas Azules</h2>
	                <p>Taza blanca con rayas azules. Un diseño clásico y atractivo que combina con cualquier decoración.</p>
	                <p>Q34.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/coffetaz8.png" alt="Hondos">
	                <h2>Taza Morada con Rayas</h2>
	                <p>Taza morada con rayas sutiles. Perfecta para quienes buscan una taza única y vibrante para su café.</p>
	                <p>Q35.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
