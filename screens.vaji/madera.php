	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/vaji/madera1.png" alt="Licuadora">

	                <h2>Platos de Madera Hondos</h2>
	                <p>Platos hondos de madera con un acabado pulido y elegante, ideales para servir sopas y guisos.</p>
	                <p>Q120.00</p>
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/madera2.png" alt="Licuadora">
	                <h2>Bases para Ollas de Madera</h2>
	                <p>Bases de madera para ollas, robustas y con un diseño que protege tus superficies de calor.</p>
	                <p>Q80.00</p>
	                <ul>
	                  <?php
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/vaji/madera3.png" alt="Hondos">
	                <h2>Juego de Platos de Madera</h2>
	                <p>Juego completo de platos de madera, perfecto para una mesa elegante y natural par on look sofisticado.</p>
	                <p>Q250.00</p>
	                <ul>
	                  <?php
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('4')">
	                <img style="width: 280px;" src="../img/vaji/madera4.png" alt="Hondos">
	                <h2>Bases de Ollas de Madera 4Pz</h2>
	                <p>Conjunto de 4 bases de madera para ollas, resistente y funcional para cualquier cocina.</p>
	                <p>Q140.00</p>
	                <ul>
	                  <?php
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/vaji/madera5.png" alt="Hondos">


	                <h2>Bases Ovaladas de Madera'</h2>
	                <p>Bases ovaladas de madera, ideales para servir platos y proteger tus superficies.</p>
	                <p>Q90.00</p>
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/madera6.png" alt="Hondos">
	                <h2>Platos Cuadrados de Madera</h2>
	                <p>Platos cuadrados de madera con un diseño moderno y elegante para tus comidas./p>
	                <p>Q150.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/vaji/madera7.png" alt="Hondos">
	                <h2>Juego de Platos de Madera</h2>
	                <p>Juego de platos de madera con diferentes tamaños, ideal para cualquier ocasión.</p>
	                <p>Q280.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/madera8.png" alt="Hondos">
	                <h2>Platos de Madera Oscuros</h2>
	                <p>Juego de platos de madera en tonos oscuros, con un acabado refinado.</p>
	                <p>Q350.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
