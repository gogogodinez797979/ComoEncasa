...
<body>
  ...
  <br>
  <center>
    <img src="../img/vaji/1.png" class="d-block w-100" alt="...">
  </center>
  ...
  <div style=" margin-top: 30px;  " class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    <div class="col">
      <div style="border:none;" class="card mb-4 rounded-3 ">
        <div style="border:none; background: white;" class="card-header py-3">
          <a href="hondos.php">
            <img style="width: 280px;" src="../img/vaji/2.png" alt="Descripción de la imagen">
          </a>
        </div>
        <div class="card-body">
          <ul class="list-unstyled mt-3 mb-4">
            <h4 class="my-0 fw-normal">Hondos</h4>
          </ul>
        </div>
      </div>
    </div>
    <div class="col">
      <div style="border:none; background: white;" class="card mb-4 rounded-3 ">
        <div style="border:none; background: white;" class="card-header py-3">
          <a href="llanos.php">
            <img style="width: 280px;" src="../img/vaji/3.png" alt="Descripción de la imagen">
          </a>
        </div>
        <div class="card-body">
          <ul class="list-unstyled mt-3 mb-4">
            <h4 class="my-0 fw-normal">Llanos</h4>
          </ul>
    ...
    <div class="col">
      <div style="border:none; background: white;" class="card mb-4 rounded-3 ">
        <div style="border:none; background: white;" class="card-header py-3">
          <a href="tzdete.php">
            <img style="width: 280px;" src="../img/vaji/4.png" alt="Descripción de la imagen">
          </a>
        </div>
        <div class="card-body">

          <ul class="list-unstyled mt-3 mb-4">
            <h4 class="my-0 fw-normal">Tazas de Té</h4>
          </ul>
    ...
    <div class="col">
      <div style="border:none; background: white;" class="card mb-4 rounded-3">
        <div style="border:none; background: white;" class="card-header py-3">
          <a href="tzdecafe.php">
            <img style="width: 280px;" src="../img/vaji/5.png" alt="Descripción de la imagen">
          </a>
        </div>
        <div class="card-body">

          <ul class="list-unstyled mt-3 mb-4">
            <h4 class="my-0 fw-normal">Tazas de Café</h4>
          </ul>
  ...
  <div style=" margin-top: 30px;  " class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    <div class="col">
      <div style="border:none;" class="card mb-4 rounded-3 ">
        <div style="border:none; background: white;" class="card-header py-3">
          <a href="salseras.php">
            <img style="width: 280px;" src="../img/vaji/6.png" alt="Descripción de la imagen">
          </a>
        </div>
        <div class="card-body">
          ...
          <ul class="list-unstyled mt-3 mb-4">
            <h4 class="my-0 fw-normal">Salseras</h4>
    ...
    <div class="col">
      <div style="border:none; background: white;" class="card mb-4 rounded-3 ">
        <div style="border:none; background: white;" class="card-header py-3">
          <a href="ceramica.php">
            <img style="width: 280px;" src="../img/vaji/7.png" alt="Descripción de la imagen">
          </a>
        ...
        <div class="card-body">
          ...
          <ul class="list-unstyled mt-3 mb-4">
            <h4 class="my-0 fw-normal">Ceramica</h4>
    ...
    <div class="col">
      <div style="border:none; background: white;" class="card mb-4 rounded-3 ">
        <div style="border:none; background: white;" class="card-header py-3">
          <a href="vidrio.php">
            <img style="width: 280px;" src="../img/vaji/8.png" alt="Descripción de la imagen">
          </a>
        </div>
        <div class="card-body">

          <ul class="list-unstyled mt-3 mb-4">
            <h4 class="my-0 fw-normal">Vidrio</h4>
          </ul>
    ...
    <div class="col">
      <div style="border:none; background: white;" class="card mb-4 rounded-3 ">
        <div style="border:none; background: white;" class="card-header py-3">
          <a href="madera.php">
            <img style="width: 280px;" src="../img/vaji/9.png" alt="Descripción de la imagen">
          </a>
        </div>
        <div class="card-body">

          <ul class="list-unstyled mt-3 mb-4">
            <h4 class="my-0 fw-normal">Madera</h4>
          </ul>
