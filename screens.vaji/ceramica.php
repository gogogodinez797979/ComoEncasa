...
<nav style="padding-top: -10px; width: 100%; height: 60px; background: #6B503C; margin-left: -1px;"> </nav>
    ...
    <style>
        ...
        .skew-container {
            overflow: hidden;
            /* Para ocultar partes del contenido diagonal */
            transform: skew(-200deg);
            /* Aplica una transformación de inclinación diagonal */
            width: 100%;
        ...
        .skew-container .carousel-inner {
            transform: skew(deg);
            /* Contrarresta la inclinación del contenedor */
        }
        ...
        @media (max-width: 768px) {
            .skew-container {
                width: auto;
                /* Cambia el ancho a automático en dispositivos pequeños */
            }
        }
    </style>

    <center>
        <div style="max-width: 600px; margin-top: 20px;" id="carouselExampleAutoplaying"
            class="carousel slide skew-container" data-bs-ride="carousel">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/vaji/ceramica1.png" alt="Licuadora">

	                <h2>Vajilla Verde Menta con Orilla Cafés</h2>
	                <p>Vajilla de cerámica con un diseño fresco y moderno en verde menta con una elegante orilla en tonos cafés.</p>
	                <p>Q200.00</p>
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/ceramica2.png" alt="Licuadora">
	                <h2>Vajilla Cafés con Orilla Blanca</h2>
	                <p>Vajilla de cerámica en tonos cafés claros, adornada con una sofisticada orilla blanca que reslta.</p>
	                <p>Q225.00</p>
	                <ul>
	                  <?php
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/vaji/ceramica3.png" alt="Hondos">
	                <h2>Vajilla Vibrante Negro y Rojo</h2>
	                <p>Vajilla de cerámica con un vibrante diseño en negro y rojo, ideal para quienes buscan un toque audaz.</p>
	                <p>Q250.00</p>
	                <ul>
	                  <?php
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('4')">
	                <img style="width: 280px;" src="../img/vaji/ceramica4.png" alt="Hondos">
	                <h2>Vajilla Gris Claro Minimalista</h2>
	                <p>Vajilla completa de cerámica en gris claro, perfecta para un estilo minimalista y elegante</p>
	                <p>Q275.00</p>
	                <ul>
	                  <?php
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/vaji/ceramica5.png" alt="Hondos">


	                <h2>Vajilla Cafés Oscuro de 4 Pzas</h2>
	                <p>Set de cuatro piezas de vajilla en cafés oscuro, ideal para una mesa elegante y sofisticada.</p>
	                <p>Q300.00</p>
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/ceramica6.png" alt="Hondos">
	                <h2>Vajilla Completa Color Musgo</h2>
	                <p>Vajilla completa en color musgo, con un acabado único que destaca en cualquier mesa.</p>
	                <p>Q350.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/vaji/ceramica7.png" alt="Hondos">
	                <h2>Recipiente para Hornear</h2>
	                <p>Recipiente de cerámica ideal para hornear tus platillos favoritos, con un diseño funcional y elegante.</p>
	                <p>Q400.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/ceramica8.png" alt="Hondos">
	                <h2>Molde para Hornear Simple</h2>
	                <p>Molde para hornear sencillo pero eficaz, adecuado para diversas recetas de repostería.</p>
	                <p>Q455.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
  ...
  <div class="container">
    <div class="row">
      <div class="col-lg-4 col-md-6" style="text-align: left;">
        ...
        <a href="../screens.vaji/indexvajillas.php" class="custom-link">
          <p>Vajillas</p>
        </a>
        <a href="../screensamueblado/indexamueblado.php" class="custom-link">
