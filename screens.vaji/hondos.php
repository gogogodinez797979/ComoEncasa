	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/bebida1.png" alt="Licuadora">

	                <h2>Fresco De Suchiles</h2>
	                <p></p>
	                <p>Q15.00</p>
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/bebida2.png" alt="Licuadora">
	                <h2>Horchata</h2>
	                <p></p>
	                <p>Q10.00</p>
	                <ul>
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/bebida3.png" alt="Licuadora">
	                <h2>ROMPOPE</h2>
	                <p></p>
	                <p>Q20.00</p>
	                <ul>
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('4')">
	                <img style="width: 280px;" src="../img/bebida4.png" alt="Licuadora">
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/bebida5.png" alt="Licuadora">
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/bebida6.png" alt="Licuadora">
	                <h2>Atol Blanco</h2>
	                <p></p>
	                <p>Q15.00</p>
	                <ul>
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/bebida7.png" alt="Licuadora">
	                <h2>Atol De Elote</h2>
	                <p></p>
	                <p>Q15.00</p>
	                <ul>
