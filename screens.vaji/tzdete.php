	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/vaji/tazas1.png" alt="Tazas de Te">

	                <h2>Taza de Té Rosa Pastel</h2>
	                <p>Taza de té de porcelana blanca con diseño floral delicado. Ideal para cualquier ocasión</p>
	                <p>Q45.00</p>
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/tazas2.png" alt="Licuadora">
	                <h2>Juego de Tazas de Te</h2>
	                <p>Taza de té moderna con patrón geométrico en tonos azules. Perfecta para una experiencia elegante.</p>
	                <p>Q50.00</p>
	                <ul>
	                  <?php
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/vaji/tazas3.png" alt="Hondos">
	                <h2>Taza de Té Dorada</h2>
	                <p>Taza de té con acabado mate y diseño minimalista. Ideal para los amantes del estilo contemporáneo.</p>
	                <p>Q55.00</p>
	                <ul>
	                  <?php
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('4')">
	                <img style="width: 280px;" src="../img/vaji/tazas4.png" alt="Hondos">
	                <h2>Taza de Té tonos Dorados y Beig</h2>
	                <p>Taza de té clásica con borde dorado. Aporta un toque de sofisticación a tu mesa.</p>
	                <p>Q60.00</p>
	                <ul>
	                  <?php
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('1')">
	                <img style="width: 280px;" src="../img/vaji/tazas5.png" alt="Hondos">


	                <h2>Taza de Té Azul Rey</h2>
	                <p>Taza de té moderna con patrón geométrico en tonos azules. Perfecta para una experiencia elegante.</p>
	                <p>Q40.00</p>
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/tazas6.png" alt="Hondos">
	                <h2>Taza de Té Celeste Cielo</h2>
	                <p>Taza de té con ilustraciones artísticas. Ideal para quienes buscan algo único.</p>
	                <p>Q65.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('3')">
	                <img style="width: 280px;" src="../img/vaji/tazas7.png" alt="Hondos">
	                <h2>Taza Estampada</h2>
	                <p>Taza de té con textura rugosa y diseño elegante. Perfecta para cualquier tipo de té.</p>
	                <p>Q50.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
	      ...
	      <div class="card mb-4 rounded-3 shadow-sm">
	        ...
	        <div class="card-body">
	          ...
	          <ul class="list-unstyled mt-3 mb-4">
	            <div class="products">
	              <div class="product" onclick="showProduct('2')">
	                <img style="width: 280px;" src="../img/vaji/tazas8.png" alt="Tazas de Te">
	                <h2>Taza de Té pequeña con orillas Doradas</h2>
	                <p>Taza de té de cerámica con motivos vintage. Aporta un toque retro a tu colección.</p>
	                <p>Q55.00</p>
	                <ul>
	                  <?php
                    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
