...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/artqM/20.png" alt="Licuadora">

        <h2>Juego de vasos altos</h2>
<p>Set de vasos altos de vidrio transparente. Incluye seis piezas.</p>
<p>Q120.00</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/21.png" alt="Licuadora">
        <h2>Copa de vino</h2>
<p>Copa de vino de cristal, diseño elegante y clásico.</p>
<p>Q45.00</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/artqM/22.png" alt="Licuadora">
        <h2>Decantador de vino</h2>
<p>Decantador de vino de cristal, ideal para oxigenar el vino.</p>
<p>Q350.00</p>
         <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/artqM/23.png" alt="Licuadora">
        <h2>Juego de vasos de whisky</h2>
<p>Set de vasos de whisky de vidrio tallado. Incluye dos piezas.</p>
<p>Q180.00</p>
        <ul>
    <?php
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/artqM/24.png" alt="Licuadora">


        <h2>Copa de martini</h2>
<p>Copa de martini de cristal, diseño elegante.</p>
<p>Q50.00</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/25.png" alt="Licuadora">
        <h2>Vaso iridiscente</h2>
<p>Vaso de vidrio con acabado iridiscente, ideal para bebidas especiales.</p>
<p>Q75.00</p>
        <ul>
    <?php
    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/artqM/26.png" alt="Licuadora">
        <h2>Vaso de vidrio transparente</h2>
<p>Vaso de vidrio transparente, diseño clásico y versátil.</p>
<p>Q35.00</p>
         <ul>
    <?php
    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/27.png" alt="Licuadora">
        <h2>Juego de vasos dorados</h2>
<p>Set de vasos de vidrio con acabado dorado. Incluye cuatro piezas.</p>
<p>Q250.00</p>
        <ul>
    <?php
    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
