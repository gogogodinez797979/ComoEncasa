...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/artqM/55.png" alt="Licuadora">

        <h2>Servilleta Roja</h2>
<p>Color rojo intenso, ideal para cenas formales.</p>
<p>Q25.99</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/56.png" alt="Licuadora">
        <h2>Paño de Microfibra Azul</h2>
<p>Juego de paños en varios tonos de azul.</p>
<p>Q35.99</p>
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/artqM/57.png" alt="Licuadora">
        <h2>Servilleta Verde Limón</h2>
<p>Juego de servilletas de color verde limón brillante.</p>
<p>Q29.99</p>
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/artqM/58.png" alt="Licuadora">
        <h2>Servilleta Verde Oliva</h2>
<p>Servilleta de tela en color verde oliva, perfecta para cenas elegantes.</p>
<p>Q34.99</p>
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/artqM/59.png" alt="Licuadora">


        <h2>Servilleta Azul Pastel</h2>
<p>Servilleta de color azul pastel con detalles en encaje.</p>
<p>Q39.99</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/60.png" alt="Licuadora">
        <h2>Paño Gris con Diseño</h2>
<p>Paño de tela gris con un elegante diseño en blanco.</p>
<p>Q45.99</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/artqM/61.png" alt="Licuadora">
        <h2>Servilleta Verde y Amarilla</h2>
<p>Juego de servilletas en colores verde y amarillo, perfecto para eventos al aire libre.</p>
<p>Q27.99</p>
         <ul>
    <?php
    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/62.png" alt="Licuadora">
        <h2>Mantel Satinado Rosa</h2>
<p>Mantel de tela satinada en color rosa, ideal para mesas de banquete.</p>
<p>Q59.99</p>
    ...
    <div class="card mb-4 rounded-3 shadow-sm">
        ...
        <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
                 <div class="products">
<div class="product" onclick="showProduct('2')">
<img   style="width: 280px;" src="../img/artqM/ss.jpeg" alt="Licuadora">
<h2>Paño de Rayas Beige</h2>
<p>Paño con diseño de rayas en tonos beige y blanco.</p>
<p>Q32.99</p>
<ul>
<?php
$producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
