...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/artqM/46.png" alt="Licuadora">

        <h2>Camino de mesa cafe</h2>
        <p>Elegante caminero de mesa  con diseño de flores, perfecto para ocasiones especiales.</p>
<p>Q199.99</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/47.png" alt="Licuadora">
        <h2>Caminero de mesa blanco
        </h2>
        <p>Caminero de mesa ideal para picnics y comidas al aire libre.</p>
<p>Q129.99</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/artqM/48.png" alt="Licuadora">
        <h2>Caminero de mesa amarillo con flecos
        </h2>
        <p>Caminero de mesa amarillo con detalles de flecos, añade un toque de color a tu mesa.</p>
<p>Q149.99</p>
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/artqM/49.png" alt="Licuadora">
        <h2>Caminero de mesa azul
        </h2>
        <p>Caminero de mesa azul con diseño bordado, perfecto para mesas largas.</p>
<p>Q99.99</p>
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/artqM/50.png" alt="Licuadora">


        <h2> Caminero de mesa beige 
        </h2>
        <p>Caminero de mesa beige con detalles, ideal para decoraciones elegantes.</p>
<p>Q89.99</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/51.png" alt="Licuadora">
        <h2> Caminero de mesa de yute
        </h2>
        <p>Caminero de mesa de yute, perfecto para decoraciones rústicas y naturales.</p>
<p>Q79.99</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/artqM/52.png" alt="Licuadora">
        <h2>Caminero de mesa beige con encaje
        </h2>
        <p>Caminero de mesa beige con detalles de encaje, elegante y refinado.</p>
<p>Q149.99</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/53.png" alt="Licuadora">
        <h2>Caminero de mesa negro
        </h2>
        <p>Caminero de mesa negro, añade un toque sofisticado y moderno.</p>
<p>Q99.99</p>
    ...
    <div class="card mb-4 rounded-3 shadow-sm">
        ...
        <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
                 <div class="products">
<div class="product" onclick="showProduct('2')">
<img   style="width: 280px;" src="../img/artqM/54.png" alt="Licuadora">
<h2>Caminero de mesa dorado</h2>
<p>Caminero de mesa dorado, perfecto para ocasiones festivas y elegantes.</p>
<p>Q139.99</p>
