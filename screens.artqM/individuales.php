...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/artqM/28.png" alt="Licuadora">

        <h2>Set de posavasos</h2>
<p>Set de posavasos de cerámica con diseño moderno. Incluye cuatro piezas.</p>
<p>Q90.00</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/29.png" alt="Licuadora">
        <h2>Bandeja de madera</h2>
<p>Bandeja de madera de bambú, ideal para servir aperitivos o como decoración.</p>
<p>Q150.00</p>
        <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/artqM/30.png" alt="Licuadora">
        <h2>Salvamanteles de ratán</h2>
<p>Salvamanteles de ratán tejido, diseño cuadrado.</p>
<p>Q80.00</p>
         <ul>
    <?php
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/artqM/31.png" alt="Licuadora">
        <h2>Tapete de mesa rojo</h2>
<p>Tapete de mesa de material sintético en color rojo.</p>
<p>Q50.00</p>
        <ul>
    <?php
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/artqM/32.png" alt="Licuadora">


        <h2>Set de tapetes redondos</h2>
<p>Set de tapetes de mesa redondos en diferentes colores. Incluye seis piezas.</p>
<p>Q180.00</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/33.png" alt="Licuadora">
        <h2>Set de tapetes tejidos</h2>
<p>Set de tapetes de mesa redondos tejidos. Incluye dos piezas.</p>
<p>Q90.00</p>
        <ul>
    <?php
    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/artqM/34.png" alt="Licuadora">
        <h2>Set de manteles individuales</h2>
<p>Set de manteles individuales con diseño floral. Incluye cuatro piezas.</p>
<p>Q120.00</p>
         <ul>
    <?php
    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/35.png" alt="Licuadora">
        <h2>Set de manteles individuales marrones</h2>
<p>Set de manteles individuales en color marrón. Incluye cuatro piezas.</p>
<p>Q100.00</p>
        <ul>
    <?php
    $producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
    ...
    <div class="card mb-4 rounded-3 shadow-sm">
        ...
        <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
                 <div class="products">
<div class="product" onclick="showProduct('2')">
<img   style="width: 280px;" src="../img/artqM/36.png" alt="Licuadora">
<h2>Servilletas de tela</h2>
<p>Set de servilletas de tela con diseño estampado. Incluye seis piezas.</p>
<p>Q75.00</p>
<ul>
<?php
$producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
