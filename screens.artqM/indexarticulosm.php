...
<br>
<center>
  <img src="../img/artqM/1.png" class="d-block w-100" alt="...">
</center>
 ...
 <div  style=" margin-top: 30px;  " class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <img  style="width: 280px;" src="../img/cuberteria.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div     class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4  class="my-0 fw-normal">Cubiertos</h4>
                ...
                <div class="col">
                    <div    style="border:none; background: white;" class="card mb-4 rounded-3 ">
                        <div   style="border:none; background: white;" class="card-header py-3">
                            <a href="platoetc.php">
    <img   style="width: 280px;"  src="../img/platovajillas.png" alt="Descripción de la imagen">
</a>
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4 class="my-0 fw-normal">Plato, Vajillas  y Accesorios</h4>
                ...
                <div class="col">
                    <div  style="border:none; background: white;"  class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                                   <a href="cristaleria.php">
    <img style="width: 280px;"    src="../img/cristaleriaa.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div class="card-body">
                         
                            <ul class="list-unstyled mt-3 mb-4">
                              <h4 class="my-0 fw-normal">Cristaleria</h4>
                            </ul>
                   ...
                   <div class="col">
                    <div  style="border:none; background: white;" class="card mb-4 rounded-3">
                        <div   style="border:none; background: white;"  class="card-header py-3">
                                                   <a href="individuales.php">
    <img style="width: 280px;"    src="../img/individuales.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div class="card-body">
...
<div  style=" margin-top: 30px;  " class="row row-cols-1 row-cols-md-4 mb-4 text-center">
                <div    class="col">
                    <div   style="border:none;" class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                                   <a href="manteles.php">
    <img  style="width: 280px;" src="../img/maneteles.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div     class="card-body">      
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4  class="my-0 fw-normal">Manteles</h4>
                ...
                <div class="col">
                    <div    style="border:none; background: white;" class="card mb-4 rounded-3 ">
                        <div   style="border:none; background: white;" class="card-header py-3">
                            <a href="caminom.php">
    <img   style="width: 280px;"  src="../img/caminom.png" alt="Descripción de la imagen">
</a>
</div>
                        <div class="card-body">
                          
                            <ul class="list-unstyled mt-3 mb-4">
                                <h4 class="my-0 fw-normal">Camino de Mesa</h4>
                ...
                <div class="col">
                    <div  style="border:none; background: white;"  class="card mb-4 rounded-3 ">
                        <div  style="border:none; background: white;" class="card-header py-3">
                                                   <a href="servilletas.php">
    <img style="width: 280px;"    src="../img/servilletas.png" alt="Descripción de la imagen">
</a>
                        </div>
                        <div class="card-body">
                         
                            <ul class="list-unstyled mt-3 mb-4">
                              <h4 class="my-0 fw-normal">Servilletas</h4>
                            </ul>
