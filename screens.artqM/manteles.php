...
<center>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/artqM/37.png" alt="Licuadora">

        <h2>Mantel Gris</h2>
        <p>Mantel de color gris, ideal para mesas de comedor o de cocina.</p>
<p>Q100.99</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/38.png" alt="Licuadora">
        <h2>Mantel a Cuadros</h2>
        <p>Mantel con diseño a cuadros en tonos claros, perfecto para un estilo clásico.</p>
<p>Q120.50</p>
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/artqM/39.png" alt="Licuadora">
        <h2>Camino de Mesa Verde</h2>
        <p>Camino de mesa en color verde con flecos en los extremos, excelente para decorar mesas largas.</p>
<p>Q85.00</p>
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/artqM/40.png" alt="Licuadora">
        <h2>Servilleta Blanca
        </h2>
        <p>Servilleta blanca de tela, ideal para cualquier ocasión.</p>
<p>Q20.00</p>
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/artqM/41.png" alt="Licuadora">


        <h2>Mantel con Diseño de Limones
        </h2>
        <p>Mantel con diseño de limones, añade un toque fresco y vibrante a tu mesa.</p>
<p>Q150.99</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/42.png" alt="Licuadora">
        <h2>Mantel de Flores
        </h2>
        <p>Mantel con diseño de flores, perfecto para una mesa elegante y acogedora.</p>
<p>Q130.75</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/artqM/43.png" alt="Licuadora">
        <h2>Mantel a Cuadros Azules
        </h2>
        <p>Mantel con diseño a cuadros en tonos azules, ideal para un estilo rústico o campestre.</p>
<p>Q110.00</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/artqM/44.png" alt="Licuadora">
        <h2>Manta Amarilla
        </h2>
        <p>Manta de color amarillo con flecos, perfecta para usar en sofás o camas.</p>
<p>Q140.50</p>
    ...
    <div class="card mb-4 rounded-3 shadow-sm">
        ...
        <div class="card-body">
            ...
            <ul class="list-unstyled mt-3 mb-4">
                 <div class="products">
<div class="product" onclick="showProduct('2')">
<img   style="width: 280px;" src="../img/artqM/45.png" alt="Licuadora">
<h2>Mantel Azul con Detalles
</h2>
<p>Mantel azul con detalles decorativos en blanco, ideal para ocasiones especiales.</p>
<p>Q160.99</p>
<ul>
<?php
$producto_id = 1; // ID del producto que deseas recuperar, puedes cambiar este valor según el producto deseado
