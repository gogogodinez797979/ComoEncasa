...
<style>
 ...
 <div style=" margin-top: 30px;"  class="row row-cols-1 row-cols-md-4 mb-4 text-center">
    ...
    <div class="product" onclick="showProduct('1')">
        <img  style="width: 280px;" src="../img/almu1.png" alt="Licuadora">

        <h2>Platanos En Mole</h2>
        <p></p>
        <p>Q30.00</p>
...
<ul>
    ...
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/almu2.png" alt="Licuadora">
        <h2>Pinol</h2>
        <p></p>
        <p>Q55.00</p>
        <ul>
    ...
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/almu3.png" alt="Licuadora">
        <h2>Fiambre</h2>
        <p></p>
        <p>Q.80.00</p>
         <ul>
    ...
    <div class="product" onclick="showProduct('4')">
        <img   style="width: 280px;" src="../img/almu4.png" alt="Licuadora">
        <h2>Pepian</h2>
        <p></p>
        <p>Q70.00</p>
        <ul>
                    ...
                    <div   class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                <div class="products">
    <div class="product" onclick="showProduct('1')">
        <img   style="width: 280px;" src="../img/almu5.png" alt="Licuadora">


        <h2>Chojin Bataneco</h2>
        <p></p>
        <p>Q55.00</p>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('2')">
        <img   style="width: 280px;" src="../img/almu6.png" alt="Licuadora">
        <h2>Jocon</h2>
        <p></p>
        <p>Q75.00</p>
        <ul>
                    ...
                    <div class="card mb-4 rounded-3 shadow-sm">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="list-unstyled mt-3 mb-4">
                                 <div class="products">
    <div class="product" onclick="showProduct('3')">
        <img   style="width: 280px;" src="../img/almu7.png" alt="Licuadora">
        <h2>Kak´ik</h2>
        <p></p>
        <p>Q60.00</p>
         <ul>
